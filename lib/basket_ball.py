...
# get points per game for a particular player
def num_points_per_game(player_name):
    for player in all_players:
        if player_name == player['name']:
            return player['points_per_game']
        
# get age of a particular player
...
# get player numbers for a given team name
...
# calculating and printing the avaerage rebounds for each shoe brand
